  ...
  render() {
    ...
    return (
      <View>
        ...
        >
           <View style={[{ flex: 1, backgroundColor: '#f7f7f7', ...ifIphoneX({  paddingTop: 50    }, {     paddingTop: 0   }) }, styles.backdrop,{marginBottom: getBottomSpace()}]}>
            <View style={[{
              overflow: 'hidden',
              // marginHorizontal: 18,
              // marginVertical: 26,
                  ...
                  <View style={styles.center}>
                    {searchIconComponent ?
                      ...
                      <Icon
                        name="search"
                        size={25}
                        style={{ marginHorizontal: 15,left:15
                         }}
                      />}
                  </View>
                  <TextInput
                ...
                >
                  <View
                    style={[{
                      ...
                      borderRadius: 0,
                      flexDirection: 'row',
                      backgroundColor: '#5fcdf2',
                    },
                    styles.button,
                    ]}
                  >
                    <Text style={[{ fontSize: 18, color: '#ffffff',letterSpacing:1, }, confirmFont, styles.confirmText]}>
                      {confirmText}
                    </Text>
                  </View>
                </Touchable>
